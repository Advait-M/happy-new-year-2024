...
class _Star():
    ...
    def update(self):
        ...
        if self._initialized and self._frame_counter < self._update_frequency:
            self._screen.print_at(self._old_char, self._x, self._y, bg=Screen.COLOUR_DEFAULT)
            # skip updating this frame!
            return
        ...
        self._screen.print_at(new_char, self._x, self._y, bg=Screen.COLOUR_DEFAULT)
